<?php /*a:1:{s:68:"/www/wwwroot/manong.yaho.cc/application/index/view/lists/plugin.html";i:1546408319;}*/ ?>
...
<div class="page-wb">
    <div class="type-list">
        ...
        <dl class="layui-clear">
            <dt><i class="layui-icon layui-icon-spread-left">&#xe66b;</i> 功能属性：<a class="on" href="/code/">不限</a></dt>
            <dd>  
    ...
    <ul class="fly-case-list layui-main">
        <?php foreach($pluginsource as $value): ?>     
        <li>
