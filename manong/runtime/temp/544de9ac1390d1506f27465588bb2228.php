<?php /*a:2:{s:83:"C:\Users\Dongyao001\Desktop\manong\application\store\view\goods_language\index.html";i:1544938799;s:77:"C:\Users\Dongyao001\Desktop\manong\application\admin\view\public\content.html";i:1534329860;}*/ ?>
<!-- 右则内容区域 开始 -->
...
<button data-open='<?php echo url("$classuri/add"); ?>' data-title="添加品牌" class='layui-btn layui-btn-sm layui-btn-primary'>添加语言</button>
<!--<?php endif; ?>-->

<!--<?php if(auth("$classuri/del")): ?>-->
<button data-update="" data-field='delete' data-action='<?php echo url("$classuri/del"); ?>' class='layui-btn layui-btn-sm layui-btn-primary'>删除语言</button>
<!--<?php endif; ?>-->
...
<form autocomplete="off" class="layui-form layui-form-pane form-search" action="<?php echo request()->url(); ?>" onsubmit="return false" method="get">
    ...
    <div class="layui-form-item layui-inline">
        ...
        <div class="layui-input-inline">
            <input name="language" value="<?php echo htmlentities(app('request')->get('language')); ?>" placeholder="请输入语言名称" class="layui-input">
        </div>
    </div>
...
<form onsubmit="return false;" data-auto="true" method="post">
    ...
    <table class="layui-table" lay-skin="line">
        ...
        <tr>
            ...
            <th class='text-left nowrap'>语言状态</th>
        ...
        <tr>
            ...
            <td class='text-left nowrap'><?php echo htmlentities($vo['language']); ?></td>
