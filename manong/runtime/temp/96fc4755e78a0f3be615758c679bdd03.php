<?php /*a:1:{s:76:"C:\Users\Dongyao001\Desktop\manong\application\index\view\member\verify.html";i:1545121791;}*/ ?>
...
<div class="site-mobile-shade"></div><div class="fly-panel fly-panel-user" pad20>
	<div class="layui-tab layui-tab-brief" lay-filter="user">
      	<ul class="layui-tab-title" id="LAY_mine">
       	        	<li class="layui-this"><a href="/member/code/verify/index">网站源码</a></li>
                	<li class=""><a href="/member/soft/verify/index">游戏源码</a></li>
                	<li class=""><a href="/member/plugin/verify/index">应用插件</a></li>
                	<li class=""><a href="/member/down/verify/index">精品软件</a></li>
                	<li class=""><a href="/member/media/verify/index">商业教程</a></li>
                	<li class=""><a href="/member/course/verify/index">文章教程</a></li>
              	</ul>
      	<div class="layui-tab-content" style="padding: 20px 0;">
			<table class="layui-table" lay-skin="line">
				<thead>
					<tr>
						<th>主题</th><th>提交时间</th><th></th>
					</tr>
				</thead>
				<tbody>
									</tbody>
...
<script type="text/javascript">
    $(document).ready(function() {
        $('#left_77').parent().parent().addClass('layui-nav-itemed');
    });
</script>
<script type="text/javascript">
    //手机设备的简单适配
