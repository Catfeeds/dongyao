<?php /*a:2:{s:63:"/www/wwwroot/manong.yaho.cc/application/store/view/toup/up.html";i:1547082871;s:70:"/www/wwwroot/manong.yaho.cc/application/admin/view/public/content.html";i:1534329860;}*/ ?>
<!-- 右则内容区域 开始 -->
...
<form onsubmit="return false;" data-auto="true" method="post">
    ...
    <table class="layui-table" lay-skin="line">
        ...
        <tr>
            ...
            <th class='text-left nowrap'>开通时间</th>
            <th class='text-left nowrap'>开通金额</th>
            <th class='text-left nowrap'>提示内容</th>
        ...
        <tr>
            ...
            <td class='text-left nowrap'>
               <?php echo htmlentities($vo['money']); ?>元
            </td>
               <td class='text-left nowrap'>
               <?php echo htmlentities($vo['desc']); ?>
            </td>
            <td class='text-left nowrap'>

                <?php if(auth("$classuri/del")): ?>
                <span class="text-explode">|</span>
                <a data-update="<?php echo htmlentities($vo['id']); ?>" data-field='delete' data-action='<?php echo url("$classuri/delete"); ?>'>删除</a>
                <?php endif; ?>
