<?php /*a:2:{s:73:"C:\Users\Dongyao001\Desktop\manong\application\store\view\goods\form.html";i:1545026442;s:77:"C:\Users\Dongyao001\Desktop\manong\application\admin\view\public\content.html";i:1534329860;}*/ ?>
<!-- 右则内容区域 开始 -->
    ...
    <div class="form-group">
        ...
        <div class='col-sm-8 text-top'>
            <select required class="layui-select full-width" name="cate_id">
                ...
                <!--<?php if(isset($vo['cate_id']) and $cate['id'] == $vo['cate_id']): ?>-->
                <option selected value="<?php echo htmlentities($cate['id']); ?>"><?php echo $cate['spl']; ?><?php echo htmlentities($cate['cate_title']); ?></option>
                <!--<?php else: ?>-->
    ...
    <div class="form-group">
        ...
        <div class='col-sm-8'>
            <select required class="layui-select full-width" name="brand_id">
                ...
                <!--<?php if($brand['id'] == (isset($vo['brand_id']) && ($vo['brand_id'] !== '')?$vo['brand_id']:0)): ?>-->
...
<!--<?php if(!empty($brands)): ?>-->
    <div class="form-group">
        <label class="col-sm-2 control-label">数据库类</label>
        <div class='col-sm-8'>
            <select required class="layui-select full-width" name="database_id">
                <?php foreach($database as $brand): ?>
                <!--<?php if($brand['id'] == (isset($vo['brand_id']) && ($vo['brand_id'] !== '')?$vo['brand_id']:0)): ?>-->
                <option selected="selected" value="<?php echo htmlentities($brand['database']); ?>"><?php echo htmlentities($brand['database']); ?></option>
                <!--<?php else: ?>-->
                <option value="<?php echo htmlentities($brand['database']); ?>"><?php echo htmlentities($brand['database']); ?></option>
                <!--<?php endif; ?>-->
                <?php endforeach; ?>
            </select>
        </div>
...
<!--<?php if(!empty($brands)): ?>-->
    <div class="form-group">
        ...
        <div class='col-sm-8'>
            <select required class="layui-select full-width" name="language_id">
                <?php foreach($language as $brand): ?>
                <!--<?php if($brand['id'] == (isset($vo['brand_id']) && ($vo['brand_id'] !== '')?$vo['brand_id']:0)): ?>-->
                <option selected="selected" value="<?php echo htmlentities($brand['language']); ?>"><?php echo htmlentities($brand['language']); ?></option>
                <!--<?php else: ?>-->
                <option value="<?php echo htmlentities($brand['language']); ?>"><?php echo htmlentities($brand['language']); ?></option>
                <!--<?php endif; ?>-->
                <?php endforeach; ?>
            </select>
        </div>
    ...
    <div class="form-group">
        ...
        <div class='col-sm-8'>
            <input name="label" required value="<?php echo htmlentities((isset($vo['label']) && ($vo['label'] !== '')?$vo['label']:'')); ?>" class="layui-input" title="请输入关键字" placeholder=",号隔开">
            <!-- <input name="goods_title" required value="<?php echo htmlentities((isset($vo['goods_title']) && ($vo['goods_title'] !== '')?$vo['goods_title']:'')); ?>" class="layui-input" title="请输入关键字" placeholder=",号隔开" style="width:85px;height:40px;float:left">&nbsp;&nbsp;&nbsp;&nbsp; -->
            <!-- <input name="goods_title" required value="<?php echo htmlentities((isset($vo['goods_title']) && ($vo['goods_title'] !== '')?$vo['goods_title']:'')); ?>" class="layui-input" title="请输入关键字" placeholder=",号隔开" style="width:85px;height:40px;float:left"> -->
        </div>
    </div>
...
<div class="form-group">
 ...
 <!--    <div class="form-group">
        ...
        <div class='col-sm-8'>
            <div class="row">
                <div class="col-sm-10 padding-right-0">
                    <input style="border-right:none" name="goods_video" value="<?php echo htmlentities((isset($vo['goods_video']) && ($vo['goods_video'] !== '')?$vo['goods_video']:'')); ?>" class="layui-input" title="请输入链接或上传视频展示文件" placeholder="请输入链接或上传视频展示文件">
                </div>
    ...
    <div class="form-group">
        <label class="col-sm-2 control-label label-required">详细描述</label>
        <div class='col-sm-8'>
            <textarea name="goods_content"><?php echo htmlentities(htmlspecialchars_decode((isset($vo['goods_content']) && ($vo['goods_content'] !== '')?$vo['goods_content']:''))); ?></textarea>
        </div>
    </div>
