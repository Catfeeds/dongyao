<?php /*a:1:{s:71:"/www/wwwroot/manong.yaho.cc/application/index/view/member/videoadd.html";i:1547090835;}*/ ?>
...
<div class="site-mobile-shade"></div><div class="fly-panel fly-panel-user" pad20>
  <div class="layui-tab layui-tab-brief" lay-filter="user">
        <ul class="layui-tab-title" id="LAY_mine">
          <li class="layui-this"><a href="/member/qiandao/">发布视频教程源码</a></li>
        </ul>
...
<div class="layui-form-item form-group" id="dr_row_yy">
    <label class="layui-form-label control-label col-md-2">视频教程：</label>
...
<div class="layui-form-item form-group" id="dr_row_demo">
    <label class="layui-form-label control-label col-md-2">相关地址：</label>
...
<script>
   $("#button").click(function(){
         ...
         //演示图片1
          ...
          if(language_id==0){
               layer.msg("请选择视频教程分类",{icon:2,time:1000});
               return false;
          }
          if(database_id==0){
               layer.msg("请选择数据库分类",{icon:2,time:1000});
               return false;
          }
          if(goods_title==0){
          ...
          if(desc==""){
               layer.msg("请输入简介",{icon:2,time:1000});
               return false;
          }
          if(files2==0){
          ...
          //ajax
          $.ajax({
                  url: "<?php echo url('/Index/Member/videoinsert'); ?>",
                  type: "post",
                  async : true,
                  data: {goods_title:goods_title,label:label,cate_id:cate_id,language_id:language_id,database_id:database_id,goods_video:goods_video,content:content,files2:files2,files:files,desc:desc,price:price,file1:file1,file2:file2,file3:file3},
                  dataType:'json',
