<?php /*a:1:{s:66:"/www/wwwroot/manong.yaho.cc/application/index/view/member/add.html";i:1547100510;}*/ ?>
...
<div class="site-mobile-shade"></div><div class="fly-panel fly-panel-user" pad20>
  <div class="layui-tab layui-tab-brief" lay-filter="user">
        <ul class="layui-tab-title" id="LAY_mine">
          <li class="layui-this"><a>发布网站源码</a></li>
        </ul>
    ...
    <select  class="form-control layui-input" id="brand_id"  >
...
<div class="layui-form-item form-group" id="dr_row_ku">
    ...
    <div class="col-md-9 layui-input-block"><div class="layui-input-inline"><label>
    <select  class="form-control layui-input" id="database_id"  >
...
<script>
   $("#button").click(function(){
          ...
          if(brand_id==0){
               layer.msg("请选择品牌分类",{icon:2,time:1000});
               return false;
          }
          if(language_id==0){
               layer.msg("请选择语言分类",{icon:2,time:1000});
               return false;
          }
          if(database_id==0){
          ...
          //ajax
          $.ajax({
                  url: "<?php echo url('/Index/Member/insert'); ?>",
                  type: "post",
                  async : true,
                  data: {goods_title:goods_title,label:label,cate_id:cate_id,brand_id:brand_id,language_id:language_id,database_id:database_id,goods_video:goods_video,content:content,files2:files2,files:files,price:price,desc:desc,file1:file1,file2:file2,file3:file3},
                  dataType:'json',
