<?php /*a:2:{s:82:"C:\Users\Dongyao001\Desktop\manong\application\store\view\goods_database\form.html";i:1544936655;s:77:"C:\Users\Dongyao001\Desktop\manong\application\admin\view\public\content.html";i:1534329860;}*/ ?>
<!-- 右则内容区域 开始 -->
...
<form autocomplete="off" onsubmit="return false;" action="<?php echo request()->url(); ?>" data-auto="true" method="post" class='form-horizontal layui-form padding-top-20'>
    ...
    <div class="form-group">
        ...
        <div class='col-sm-8'>
            <input autofocus name="database" value='<?php echo htmlentities((isset($vo['database']) && ($vo['database'] !== '')?$vo['database']:"")); ?>' required="required" title="请输入数据库名称" placeholder="请输入数据库名称" class="layui-input">
        </div>
    </div>
