<?php /*a:1:{s:70:"/www/wwwroot/manong.yaho.cc/application/index/view/member/tooladd.html";i:1547090856;}*/ ?>
...
<div class="site-mobile-shade"></div><div class="fly-panel fly-panel-user" pad20>
  <div class="layui-tab layui-tab-brief" lay-filter="user">
        <ul class="layui-tab-title" id="LAY_mine">
          <li class="layui-this"><a href="/member/qiandao/">发布精品工具源码</a></li>
        </ul>
...
<div class="layui-form-item form-group" id="dr_row_yy">
    <label class="layui-form-label control-label col-md-2">适用环境：</label>
...
<div class="layui-form-item form-group" id="dr_row_demo">
    <label class="layui-form-label control-label col-md-2">相关网址：</label>
...
<script>
   $("#button").click(function(){
          ...
          //ajax
          $.ajax({
                  url: "<?php echo url('/Index/Member/toolinsert'); ?>",
                  type: "post",
                  async : true,
                  data: {goods_title:goods_title,label:label,cate_id:cate_id,language_id:language_id,goods_video:goods_video,content:content,files2:files2,files:files,desc:desc,price:price,file1:file1,file2:file2,file3:file3},
                  dataType:'json',
