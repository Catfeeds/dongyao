<?php /*a:1:{s:75:"C:\Users\Dongyao001\Desktop\manong\application\admin\view\plugs\upfile.html";i:1534329860;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
    <head>
    ...
    <body>
        ...
        <script>
            ...
            function uploaded(ret, file) {
                ...
                /*<?php if($mode === 'one'): ?>*/
                top.$('[name="<?php echo htmlentities($field); ?>"]').map(function () {
            ...
            $(function () {
                ...
                WebUploader.Uploader.register({'before-send-file': 'preupload'}, {
                    preupload: function (file) {
                        ...
                        owner.md5File(file.source).fail(function () {
                            ...
                            file.md5 = md5;
                            var data = {id: file.id, md5: md5, uptype: '<?php echo htmlentities($uptype); ?>', filename: file.name};
                ...
                uploader = WebUploader.create({
                    ...
                    accept: {title: '选择文件', extensions: '<?php echo htmlentities($types); ?>', mimeTypes: '<?php echo htmlentities($mimes); ?>'},
                    formData: {},
                    /*<?php if($mode === 'one'): ?>*/
                    auto: true,
                    fileNumLimit: 1,
