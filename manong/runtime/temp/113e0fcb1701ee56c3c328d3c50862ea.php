<?php /*a:2:{s:79:"C:\Users\Dongyao001\Desktop\manong\application\store\view\goods_spec\index.html";i:1544937558;s:77:"C:\Users\Dongyao001\Desktop\manong\application\admin\view\public\content.html";i:1534329860;}*/ ?>
<!-- 右则内容区域 开始 -->
...
<form autocomplete="off" class="layui-form layui-form-pane form-search" action="<?php echo request()->url(); ?>" onsubmit="return false" method="get">
    ...
    <div class="layui-form-item layui-inline">
        ...
        <div class="layui-input-inline">
            <input name="language" value="<?php echo htmlentities((app('request')->get('language') ?: '')); ?>" placeholder="请输入开发语言" class="layui-input">
        </div>
    </div>
...
<form autocomplete="off" onsubmit="return false;" data-auto="true" method="post">
    ...
    <table class="layui-table" lay-skin="line" lay-size="sm">
        ...
        <tr>
            ...
            <th class='text-left nowrap'>开发语言</th>
        ...
        <tr>
            ...
            <td class='text-left text-top nowrap'><?php echo htmlentities($vo['language']); ?></td>
