<?php /*a:2:{s:83:"C:\Users\Dongyao001\Desktop\manong\application\store\view\goods_database\index.html";i:1544936255;s:77:"C:\Users\Dongyao001\Desktop\manong\application\admin\view\public\content.html";i:1534329860;}*/ ?>
<!-- 右则内容区域 开始 -->
...
<button data-open='<?php echo url("$classuri/add"); ?>' data-title="添加品牌" class='layui-btn layui-btn-sm layui-btn-primary'>添加数据库</button>
<!--<?php endif; ?>-->

<!--<?php if(auth("$classuri/del")): ?>-->
<button data-update="" data-field='delete' data-action='<?php echo url("$classuri/del"); ?>' class='layui-btn layui-btn-sm layui-btn-primary'>删除数据库</button>
<!--<?php endif; ?>-->
...
<form autocomplete="off" class="layui-form layui-form-pane form-search" action="<?php echo request()->url(); ?>" onsubmit="return false" method="get">
    ...
    <div class="layui-form-item layui-inline">
        ...
        <div class="layui-input-inline">
            <input name="database" value="<?php echo htmlentities(app('request')->get('database')); ?>" placeholder="请输入数据库名称" class="layui-input">
        </div>
    </div>
...
<form onsubmit="return false;" data-auto="true" method="post">
    ...
    <table class="layui-table" lay-skin="line">
        ...
        <tr>
            ...
            <th class='text-left nowrap'>数据库</th>
            <th class='text-left nowrap'>添加时间</th>
            <th class='text-left nowrap'>数据库状态</th>
        ...
        <tr>
            ...
            <td class='text-left nowrap'><?php echo htmlentities($vo['database']); ?></td>
            ...
            <td class='text-left nowrap'>
                ...
                <a data-title="编辑数据库" data-open='<?php echo url("$classuri/edit"); ?>?id=<?php echo htmlentities($vo['id']); ?>'>编辑</a>
