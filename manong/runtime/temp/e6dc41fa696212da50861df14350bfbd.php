<?php /*a:2:{s:77:"C:\Users\Administrator\Desktop\toupiao\application\vote\view\goods\index.html";i:1537951229;s:81:"C:\Users\Administrator\Desktop\toupiao\application\admin\view\public\content.html";i:1534329860;}*/ ?>
<!-- 右则内容区域 开始 -->
     ...
     <?php foreach($list as $key=>$value): ?>
        <tr>
            ...
            <td class='text-left nowrap'>
                ...
                <span class="text-explode">|</span>
                <?php if($value['status'] == "1"): ?>
                <a title="审核" onclick="member_statusedit(this,'<?php echo htmlentities($value['id']); ?>')" href="javascript:;">审核</a>
                <?php else: ?>
                  已审核
                <?php endif; ?> 
