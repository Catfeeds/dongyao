<?php /*a:2:{s:79:"C:\Users\Dongyao001\Desktop\manong\application\store\view\goods_brand\form.html";i:1544934665;s:77:"C:\Users\Dongyao001\Desktop\manong\application\admin\view\public\content.html";i:1534329860;}*/ ?>
<!-- 右则内容区域 开始 -->
...
<form autocomplete="off" onsubmit="return false;" action="<?php echo request()->url(); ?>" data-auto="true" method="post" class='form-horizontal layui-form padding-top-20'>
    ...
    <div class="form-group">
        ...
        <div class='col-sm-8'>
            <input autofocus name="brand_title" value='<?php echo htmlentities((isset($vo['brand_title']) && ($vo['brand_title'] !== '')?$vo['brand_title']:"")); ?>' required="required" title="请输入品牌名称" placeholder="请输入品牌名称" class="layui-input">
        </div>
    </div>
