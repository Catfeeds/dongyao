<?php /*a:1:{s:70:"/www/wwwroot/manong.yaho.cc/application/index/view/member/gameadd.html";i:1547090126;}*/ ?>
...
<div class="site-mobile-shade"></div><div class="fly-panel fly-panel-user" pad20>
  <div class="layui-tab layui-tab-brief" lay-filter="user">
        <ul class="layui-tab-title" id="LAY_mine">
          <li class="layui-this"><a >发布游戏源码</a></li>
        </ul>
...
<script>
   $("#button").click(function(){
          ...
          //ajax
          $.ajax({
                  url: "<?php echo url('/Index/Member/gameinsert'); ?>",
                  type: "post",
                  async : true,
