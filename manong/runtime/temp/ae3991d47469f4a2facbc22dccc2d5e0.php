<?php /*a:2:{s:67:"/www/wwwroot/manong.yaho.cc/application/store/view/goods/index.html";i:1545980477;s:70:"/www/wwwroot/manong.yaho.cc/application/admin/view/public/content.html";i:1534329860;}*/ ?>
<!-- 右则内容区域 开始 -->
...
<form onsubmit="return false;" data-auto="true" method="post">
 ...
 -->
        ...
        <tr>
            ...
            <td class="text-left nowrap text-top">
                品牌：<?php echo (isset($vo['brand']['brand_title']) && ($vo['brand']['brand_title'] !== '')?$vo['brand']['brand_title']:'<span class="color-desc">无</span>'); ?><br>
               ...
               <td class="text-left nowrap text-top">
                ...
                数据库：<?php if($vo['database_id'] == '0'): ?>无<?php else: ?><?php echo htmlentities($vo['database_id']); endif; ?>
                ...
                <td class="text-left nowrap text-top">
               <img src="<?php echo htmlentities($vo['goods_logo']); ?>" style="width:97px;height:84px;">
